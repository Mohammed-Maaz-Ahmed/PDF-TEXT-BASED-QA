...
def load_model():
    ...
    tokenizer = AutoTokenizer.from_pretrained("https://github.dev/Mohammed-Maaz-Ahmed/PDF-TEXT-BASED-QA/blob/18a6572ac29f88496d1cd53ee4d5ddc7828dc05b/saved_tokenizer")
